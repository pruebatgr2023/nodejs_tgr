Feature: link Pago - ConveniosPago - IMPRIMIRDOCUMENTOS - ImprimirCuotasConveniosVigentes
          Yo como usuario quiero entrar al portal TGR y Verificar funcionalidad de link Imprimir Cuotas de Convenios Vigentes
          
 Scenario: Validamos funcionalidad de links Imprimir Cuotas de Convenios Vigentes
   ...
   And se espera "3" segundos
   And se encuentra un elemento "#menu-item-16172 > a > span" con el texto "Imprimir Cuotas de Convenios Vigentes"
   And se espera "3" segundos
   And se cliquea el elemento "a" con el texto "Imprimir Cuotas de Convenios Vigentes"
