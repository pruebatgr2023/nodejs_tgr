Feature: link Pago - MultasPatentesOtros - MULTAS - PatentesMineras
          Yo como usuario quiero entrar al portal TGR y Verificar funcionalidad de link Patentes Mineras

 Scenario: Validamos funcionalidad de links Patentes Mineras
