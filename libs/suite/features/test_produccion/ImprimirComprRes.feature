Feature: Link Pagos - Convenios de Pago - ImprimirComprobanteResolucion
  Yo como usuario quiero entrar al portal TGR y Verificar funcionalidad de link Pagos-Convenios de Pago-ImprimirComprobanteResolucion
