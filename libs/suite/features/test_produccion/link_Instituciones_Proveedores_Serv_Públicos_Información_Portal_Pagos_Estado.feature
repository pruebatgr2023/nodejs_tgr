Feature: link Instituciones y Proveedores - Serv. Públicos - Información Portal de Pagos del Estado
          Yo como usuario quiero entrar al portal TGR y Verificar funcionalidad de link Instituciones y Proveedores - Serv. Públicos - Información Portal de Pagos del Estado
        
Scenario: Validamos funcionalidad de links Instituciones y Proveedores - sub link Serv. Públicos - Información Portal de Pagos del Estado
   ...
   When se cliquea el selector "#menu-item-16213 > a" 
   And se espera "3" segundos 
