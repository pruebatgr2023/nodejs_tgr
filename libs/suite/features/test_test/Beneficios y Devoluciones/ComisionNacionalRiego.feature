Feature: Link Beneficios y Devoluciones - Beneficios y Devoluciones - Consultas-Comisión Nacional de Riego CNR, SUBPESCA y Portuarios
 Yo como usuario quiero entrar al portal TGR y Verificar funcionalidad de link Beneficios y Devoluciones-Consultas-Comisión Nacional de Riego CNR, SUBPESCA y Portuarios
 ...
 Scenario: reconocemos elementos menu princial, ingresamos a pago y reconocemos links del menú pago de convenios
   ...
   And se espera "3" segundos
   And se encuentra un elemento "#menu-item-15924 > a > span" con el texto "Comisión Nacional de Riego CNR, SUBPESCA y Portuarios"
   And se espera "3" segundos
   And se cliquea el elemento "a" con el texto "Comisión Nacional de Riego CNR, SUBPESCA y Portuarios"
