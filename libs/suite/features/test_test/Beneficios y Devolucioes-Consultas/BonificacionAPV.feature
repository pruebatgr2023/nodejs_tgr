Feature: Link Beneficios y Devoluciones - Beneficios y Devoluciones - Consultas-Bonificación APV Ley 3.500
 Yo como usuario quiero entrar al portal TGR y Verificar funcionalidad de link Beneficios y Devoluciones-Consultas-Bonificación APV Ley 3.500
 ...
 Scenario: reconocemos elementos menu princial, ingresamos a pago y reconocemos links del menú pago de convenios
   ...
   And se espera "3" segundos
   And se encuentra un elemento "#menu-item-15926 > a > span" con el texto "Bonificación APV Ley 3.500"
   And se espera "3" segundos
   And se cliquea el elemento "a" con el texto "Bonificación APV Ley 3.500"
