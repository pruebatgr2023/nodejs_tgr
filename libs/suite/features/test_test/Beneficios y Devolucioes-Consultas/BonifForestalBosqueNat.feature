Feature: Link Beneficios y Devoluciones - Beneficios y Devoluciones - Consultas-Bonificación Forestal y Bosque Nativo
 Yo como usuario quiero entrar al portal TGR y Verificar funcionalidad de link Beneficios y Devoluciones-Consultas-Bonificación Forestal y Bosque Nativo
 ...
 Scenario: reconocemos elementos menu princial, ingresamos a pago y reconocemos links del menú pago de convenios
   ...
   And se espera "3" segundos
   And se encuentra un elemento "#menu-item-15929 > a > span" con el texto "Bonificación Forestal y Bosque Nativo"
   And se espera "3" segundos
   And se cliquea el elemento "a" con el texto "Bonificación Forestal y Bosque Nativo"
