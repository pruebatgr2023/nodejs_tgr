Feature: Link Beneficios y Devoluciones - Beneficios y Devoluciones - Consultas-Beneficios Trabajadores Independientes
 Yo como usuario quiero entrar al portal TGR y Verificar funcionalidad de link Beneficios y Devoluciones-Consultas-Beneficios Trabajadores Independientes
 ...
 Scenario: reconocemos elementos menu princial, ingresamos a pago y reconocemos links del menú pago de convenios
   ...
   And se espera "3" segundos
   And se encuentra un elemento "#menu-item-16261 > a > span" con el texto "Beneficios Trabajadores Independientes"
   And se espera "3" segundos
   And se cliquea el elemento "a" con el texto "Beneficios Trabajadores Independientes"
