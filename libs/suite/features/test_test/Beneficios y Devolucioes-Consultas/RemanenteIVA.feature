Feature: Link Beneficios y Devoluciones - Consultas-Remanente de IVA Crédito (Nuevo)
 Yo como usuario quiero entrar al portal TGR y Verificar funcionalidad de link Beneficios y Devoluciones-Consultas-Remanente de IVA Crédito (Nuevo)
