Feature: Link Beneficios y Devoluciones - Consultas-Subsidio Ingreso Minimo
 ...
 Scenario: reconocemos elementos menu princial, ingresamos a pago y reconocemos links del menú pago de convenios
   ...
   And se encuentra un elemento "#menu-item-14909 > a > span" con el texto "Subsidio Ingreso Mínimo Mipymes​"
   And se espera "5" segundos
   And se cliquea el elemento "a" con el texto "Subsidio Ingreso Mínimo Mipymes"
   And se espera "5" segundos
   And se encuentra un elemento "h1" con la clase "elementor-heading-title" con el texto "Subsidio Ingreso Mínimo Mipymes"
   And se espera "5" segundos
   And se encuentra un elemento "h2" con la clase "elementor-heading-title" con el texto "¿Ya realizaste la postulación?"
   And se espera "5" segundos
